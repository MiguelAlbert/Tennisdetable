...
public class DoublesDetail extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvNomJoueurUn.setText(String.valueOf(matchDouble.namej1a)+"-"+String.valueOf(matchDouble.namej1b));
        tvNomJoueurDeux.setText(String.valueOf(matchDouble.namej2a)+"-"+String.valueOf(matchDouble.namej2b));
        tvDate.setText("Date du match : " + matchDouble.date);
        date = matchDouble.date;
        tvTotalSetsJ1.setText(String.valueOf(matchDouble.scoreSetj1));
        tvTotalSetsJ2.setText(String.valueOf(matchDouble.scoreSetj2));
        tvScoreSet1J1.setText(String.valueOf(matchDouble.score_set1_j1));
        tvScoreSet1J2.setText(String.valueOf(matchDouble.score_set1_j2));
        tvScoreSet2J1.setText(String.valueOf(matchDouble.score_set2_j1));
        tvScoreSet2J2.setText(String.valueOf(matchDouble.score_set2_j2));
        tvScoreSet3J1.setText(String.valueOf(matchDouble.score_set3_j1));
        tvScoreSet3J2.setText(String.valueOf(matchDouble.score_set3_j2));
        tvScoreSet4J1.setText(String.valueOf(matchDouble.score_set4_j1));
        tvScoreSet4J2.setText(String.valueOf(matchDouble.score_set4_j2));
        tvScoreSet5J1.setText(String.valueOf(matchDouble.score_set5_j1));
        tvScoreSet5J2.setText(String.valueOf(matchDouble.score_set5_j2));
        tvScoreSet6J1.setText(String.valueOf(matchDouble.score_set6_j1));
        tvScoreSet6J2.setText(String.valueOf(matchDouble.score_set6_j2));
        tvScoreSet7J1.setText(String.valueOf(matchDouble.score_set7_j1));
        tvScoreSet7J2.setText(String.valueOf(matchDouble.score_set7_j2));
        nombreDeSets = String.valueOf(matchDouble.nbsets);
        if (nombreDeSets== "1") {
            tvTitreNbSets.setText("Match en double - 1 set");
        } else {
            tvTitreNbSets.setText("Match en double - " + matchDouble.nbsets + " sets");
        }
        afficheTableau();
    }
