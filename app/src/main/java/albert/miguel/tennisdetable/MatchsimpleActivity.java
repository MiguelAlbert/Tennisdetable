...
import albert.miguel.tennisdetable.BaseDeDonnees.Simples;
import albert.miguel.tennisdetable.BaseDeDonnees.SimplesRepo;


public class MatchsimpleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_matchsimple);
        ...
        if (nbSetsAJouer == "1") {
            ...
            tvTitreNbSets.setText("Match en simple - " + nbSetsAJouer + " sets");
        }
        ...
        String nomJoueurCompletJ1 = getIntent().getExtras().getString("nomJoueurCompletJ1");
        tvNomJoueurUn.setText(nomJoueurCompletJ1);

        tvNomJoueurDeux = (TextView) findViewById(R.id.tvNomJoueurDeux);
        String nomJoueurCompletJ2 = getIntent().getExtras().getString("nomJoueurCompletJ2");
        ...
        imageButtonSave.setOnClickListener(new stockage());
        ...
        builder
                ...
                .setPositiveButton("Oui", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        MatchsimpleActivity.this.finish();
                    }
                })
            ...
            if((intNbSetsAJouer == 3)||(intNbSetsAJouer == 5)||(intNbSetsAJouer == 7)){
                if((nbSetsGauche+nbSetsDroite)==(intNbSetsAJouer - 1)){
                    if((pointSetGauche == 4) ||(pointSetDroite ==4)){
                        Toast.makeText(MatchsimpleActivity.this, "Les joueurs doivent revenir à leur place", Toast.LENGTH_SHORT).show();
        ...
        builder
                ...
                .setPositiveButton("Oui", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(MatchsimpleActivity.this, "Vous avez validé la fin du set", Toast.LENGTH_SHORT).show();
        ...
        if ((nbSetsGauche == ((intNbSetsAJouer + 1) / 2)) || (nbSetsDroite == ((intNbSetsAJouer + 1) / 2))) {
            ...
            builder
                    ...
                    .setPositiveButton("Oui", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            //Yes button clicked, do something
                            Toast.makeText(MatchsimpleActivity.this, "Vous avez validé la fin du match", Toast.LENGTH_SHORT).show();
    ...
    private class stockage implements View.OnClickListener {
        ...
        @Override
        public void onClick(View v) {
            SimplesRepo repo = new SimplesRepo(MatchsimpleActivity.this);
            Simples matchSimple = new Simples();
            matchSimple.simple_ID = _Simple_Id;
            matchSimple.namej2 = tvNomJoueurDeux.getText().toString();
            matchSimple.namej1 = tvNomJoueurUn.getText().toString();

            Date date = Calendar.getInstance().getTime();
            DateFormat formatter = new SimpleDateFormat("dd/MM/yy");
            String today = formatter.format(date);

            matchSimple.date = today;
            matchSimple.nbsets = Integer.parseInt(String.valueOf(intNbSetsAJouer));
            matchSimple.scoreSetj1 = Integer.parseInt(tvTotalSetsJ1.getText().toString());
            matchSimple.scoreSetj2 = Integer.parseInt(tvTotalSetsJ2.getText().toString());
            matchSimple.score_set1_j1 = Integer.parseInt(tvScoreSet1J1.getText().toString());
            matchSimple.score_set1_j2 = Integer.parseInt(tvScoreSet1J2.getText().toString());
            matchSimple.score_set2_j1 = Integer.parseInt(tvScoreSet2J1.getText().toString());
            matchSimple.score_set2_j2 = Integer.parseInt(tvScoreSet2J2.getText().toString());
            matchSimple.score_set3_j1 = Integer.parseInt(tvScoreSet3J1.getText().toString());
            matchSimple.score_set3_j2 = Integer.parseInt(tvScoreSet3J2.getText().toString());
            matchSimple.score_set4_j1 = Integer.parseInt(tvScoreSet4J1.getText().toString());
            matchSimple.score_set4_j2 = Integer.parseInt(tvScoreSet4J2.getText().toString());
            matchSimple.score_set5_j1 = Integer.parseInt(tvScoreSet5J1.getText().toString());
            matchSimple.score_set5_j2 = Integer.parseInt(tvScoreSet5J2.getText().toString());
            matchSimple.score_set6_j1 = Integer.parseInt(tvScoreSet6J1.getText().toString());
            matchSimple.score_set6_j2 = Integer.parseInt(tvScoreSet6J2.getText().toString());
            matchSimple.score_set7_j1 = Integer.parseInt(tvScoreSet7J1.getText().toString());
            matchSimple.score_set7_j2 = Integer.parseInt(tvScoreSet7J2.getText().toString());

            if (_Simple_Id == 0) {
                _Simple_Id = repo.insert(matchSimple);
                Toast.makeText(MatchsimpleActivity.this, "Match simple enregistré", Toast.LENGTH_SHORT).show();
            }
        }
    }
